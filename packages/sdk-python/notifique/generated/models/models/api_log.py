...
class ApiLog(BaseModel):
    ...
    request_query: Optional[Dict[str, Any]] = Field(default=None, alias="requestQuery")
    ...
    __properties: ClassVar[List[str]] = ["id", "apiKeyId", "instanceId", "endpoint", "method", "status", "userAgent", "ip", "requestQuery", "requestBody", "responseBody", "duration", "createdAt"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ip": obj.get("ip"),
            "requestQuery": obj.get("requestQuery"),
