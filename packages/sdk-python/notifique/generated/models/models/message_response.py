...
from notifique.generated.models.models.message_response_data import MessageResponseData
...
class MessageResponse(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": MessageResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
