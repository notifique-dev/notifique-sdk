...
namespace Notifique.OpenApi.Models.Client
{
    ...
    /// </summary>
    /// <typeparam name="TType"></typeparam>
    public interface IPreconditionRequired<TType> : IApiResponse
    {
        /// <summary>
        /// Deserializes the response if the response is PreconditionRequired
        /// </summary>
        /// <returns></returns>
        TType PreconditionRequired();

        /// <summary>
        /// Returns true if the response is PreconditionRequired and the deserialized response is not null
        /// </summary>
        /// <param name="result"></param>
        /// <returns></returns>
        bool TryPreconditionRequired([NotNullWhen(true)]out TType? result);
    }
