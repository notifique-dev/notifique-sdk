...
namespace Notifique.OpenApi.Models.Model
{
    ...
    public partial class Pagination : IValidatableObject
    {
        ...
        [JsonConstructor]
        public Pagination(Option<int?> total = default, Option<int?> page = default, Option<int?> limit = default, Option<int?> totalPages = default)
        {
            TotalOption = total;
            PageOption = page;
            LimitOption = limit;
    ...
    /// </summary>
    public partial class PaginationJsonConverter : JsonConverter<Pagination>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="PaginationJsonConverter" /> class.
        /// </summary>
        public PaginationJsonConverter()
        {
            OnCreated();
        }
