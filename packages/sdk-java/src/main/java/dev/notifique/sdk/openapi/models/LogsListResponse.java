...
import dev.notifique.sdk.openapi.models.ApiLog;
import dev.notifique.sdk.openapi.models.Pagination;
 ...
 */
@JsonPropertyOrder({
  LogsListResponse.JSON_PROPERTY_SUCCESS,
  LogsListResponse.JSON_PROPERTY_DATA,
  LogsListResponse.JSON_PROPERTY_PAGINATION
})
...
public class LogsListResponse {
  ...
  @javax.annotation.Nonnull
  private List<ApiLog> data = new ArrayList<>();
  ...
  public LogsListResponse success(@javax.annotation.Nonnull Boolean success) {
  ...
  public LogsListResponse data(@javax.annotation.Nonnull List<ApiLog> data) {
    this.data = data;
    return this;
  }

  public LogsListResponse addDataItem(ApiLog dataItem) {
    if (this.data == null) {
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setData(@javax.annotation.Nonnull List<ApiLog> data) {
    this.data = data;
  }


  public LogsListResponse pagination(@javax.annotation.Nonnull Pagination pagination) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.success, logsListResponse.success) &&
        Objects.equals(this.data, logsListResponse.data) &&
        Objects.equals(this.pagination, logsListResponse.pagination);
  }
