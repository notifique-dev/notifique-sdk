...
@JsonPropertyOrder({
  ...
  ErrorResponse.JSON_PROPERTY_MISSING_VARIABLES
})
...
public class ErrorResponse {
  ...
  public static final String JSON_PROPERTY_MISSING_VARIABLES = "missingVariables";
  ...
  public ErrorResponse code(@javax.annotation.Nonnull String code) {
    this.code = code;
    return this;
  }
  ...
  public ErrorResponse missingVariables(@javax.annotation.Nullable List<String> missingVariables) {
    this.missingVariables = missingVariables;
    return this;
  }

  public ErrorResponse addMissingVariablesItem(String missingVariablesItem) {
   ...
   */
  @javax.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_MISSING_VARIABLES, required = false)
  ...
  @JsonProperty(value = JSON_PROPERTY_MISSING_VARIABLES, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setMissingVariables(@javax.annotation.Nullable List<String> missingVariables) {
    this.missingVariables = missingVariables;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.success, errorResponse.success) &&
        ...
        Objects.equals(this.missingVariables, errorResponse.missingVariables);
  }

  @Override
  public int hashCode() {
    return Objects.hash(success, error, message, code, missingVariables);
  }
  ...
  public String toString() {
    ...
    sb.append("    missingVariables: ").append(toIndentedString(missingVariables)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `missingVariables` to the URL query string
    if (getMissingVariables() != null) {
      for (int i = 0; i < getMissingVariables().size(); i++) {
        joiner.add(String.format(java.util.Locale.ROOT, "%smissingVariables%s%s=%s", prefix, suffix,
            "".equals(suffix) ? "" : String.format(java.util.Locale.ROOT, "%s%d%s", containerPrefix, i, containerSuffix),
            ApiClient.urlEncode(ApiClient.valueToString(getMissingVariables().get(i)))));
      }
    }
