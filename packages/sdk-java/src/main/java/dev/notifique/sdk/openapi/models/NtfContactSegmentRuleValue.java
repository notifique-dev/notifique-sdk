...
@JsonDeserialize(using = NtfContactSegmentRuleValue.NtfContactSegmentRuleValueDeserializer.class)
@JsonSerialize(using = NtfContactSegmentRuleValue.NtfContactSegmentRuleValueSerializer.class)
public class NtfContactSegmentRuleValue extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(NtfContactSegmentRuleValue.class.getName());

    public static class NtfContactSegmentRuleValueSerializer extends StdSerializer<NtfContactSegmentRuleValue> {
        public NtfContactSegmentRuleValueSerializer(Class<NtfContactSegmentRuleValue> t) {
            super(t);
        }

        public NtfContactSegmentRuleValueSerializer() {
            this(null);
        }

        @Override
        public void serialize(NtfContactSegmentRuleValue value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class NtfContactSegmentRuleValueDeserializer extends StdDeserializer<NtfContactSegmentRuleValue> {
        public NtfContactSegmentRuleValueDeserializer() {
            this(NtfContactSegmentRuleValue.class);
        }

        public NtfContactSegmentRuleValueDeserializer(Class<?> vc) {
            super(vc);
        }

        @Override
        public NtfContactSegmentRuleValue deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            if (match == 1) {
                NtfContactSegmentRuleValue ret = new NtfContactSegmentRuleValue();
                ret.setActualInstance(deserialized);
                return ret;
            }
            throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for NtfContactSegmentRuleValue: %d classes match result, expected 1", match));
        }
         ...
         */
        @Override
        public NtfContactSegmentRuleValue getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            throw new JsonMappingException(ctxt.getParser(), "NtfContactSegmentRuleValue cannot be null");
        }
    }
    ...
    public NtfContactSegmentRuleValue() {
        super("oneOf", Boolean.FALSE);
    }

    public NtfContactSegmentRuleValue(BigDecimal o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public NtfContactSegmentRuleValue(Boolean o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public NtfContactSegmentRuleValue(String o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    static {
        ...
        JSON.registerDescendants(NtfContactSegmentRuleValue.class, Collections.unmodifiableMap(schemas));
    }

    @Override
    public Map<String, Class<?>> getSchemas() {
        return NtfContactSegmentRuleValue.schemas;
    }
