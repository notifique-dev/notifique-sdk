...
import dev.notifique.sdk.openapi.models.MessageResponseData;
 ...
 */
@JsonPropertyOrder({
  MessageResponse.JSON_PROPERTY_SUCCESS,
...
public class MessageResponse {
  ...
  public MessageResponse data(@javax.annotation.Nullable MessageResponseData data) {
    this.data = data;
    return this;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(@javax.annotation.Nullable MessageResponseData data) {
    this.data = data;
  }
