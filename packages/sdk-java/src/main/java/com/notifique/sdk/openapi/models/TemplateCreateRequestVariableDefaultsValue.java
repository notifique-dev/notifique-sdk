...
@JsonDeserialize(using = TemplateCreateRequestVariableDefaultsValue.TemplateCreateRequestVariableDefaultsValueDeserializer.class)
@JsonSerialize(using = TemplateCreateRequestVariableDefaultsValue.TemplateCreateRequestVariableDefaultsValueSerializer.class)
public class TemplateCreateRequestVariableDefaultsValue extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(TemplateCreateRequestVariableDefaultsValue.class.getName());

    public static class TemplateCreateRequestVariableDefaultsValueSerializer extends StdSerializer<TemplateCreateRequestVariableDefaultsValue> {
        public TemplateCreateRequestVariableDefaultsValueSerializer(Class<TemplateCreateRequestVariableDefaultsValue> t) {
            super(t);
        }

        public TemplateCreateRequestVariableDefaultsValueSerializer() {
            this(null);
        }

        @Override
        public void serialize(TemplateCreateRequestVariableDefaultsValue value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class TemplateCreateRequestVariableDefaultsValueDeserializer extends StdDeserializer<TemplateCreateRequestVariableDefaultsValue> {
        public TemplateCreateRequestVariableDefaultsValueDeserializer() {
            this(TemplateCreateRequestVariableDefaultsValue.class);
        }

        public TemplateCreateRequestVariableDefaultsValueDeserializer(Class<?> vc) {
            super(vc);
        }

        @Override
        public TemplateCreateRequestVariableDefaultsValue deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            if (match == 1) {
                TemplateCreateRequestVariableDefaultsValue ret = new TemplateCreateRequestVariableDefaultsValue();
                ret.setActualInstance(deserialized);
                return ret;
            }
            throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for TemplateCreateRequestVariableDefaultsValue: %d classes match result, expected 1", match));
        }
         ...
         */
        @Override
        public TemplateCreateRequestVariableDefaultsValue getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            throw new JsonMappingException(ctxt.getParser(), "TemplateCreateRequestVariableDefaultsValue cannot be null");
        }
    }
    ...
    public TemplateCreateRequestVariableDefaultsValue() {
        super("oneOf", Boolean.FALSE);
    }

    public TemplateCreateRequestVariableDefaultsValue(BigDecimal o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public TemplateCreateRequestVariableDefaultsValue(String o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    static {
        ...
        JSON.registerDescendants(TemplateCreateRequestVariableDefaultsValue.class, Collections.unmodifiableMap(schemas));
    }

    @Override
    public Map<String, Class<?>> getSchemas() {
        return TemplateCreateRequestVariableDefaultsValue.schemas;
    }
