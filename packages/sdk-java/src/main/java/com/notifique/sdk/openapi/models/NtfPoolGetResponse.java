 ...
 */
@JsonPropertyOrder({
  NtfPoolGetResponse.JSON_PROPERTY_SUCCESS,
  NtfPoolGetResponse.JSON_PROPERTY_DATA
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.25.0-SNAPSHOT")
public class NtfPoolGetResponse {
  /**
  ...
  public NtfPoolGetResponse() { 
  }

  public NtfPoolGetResponse success(@javax.annotation.Nullable SuccessEnum success) {
  ...
  public NtfPoolGetResponse data(@javax.annotation.Nullable Map<String, Object> data) {
    this.data = data;
    return this;
  }

  public NtfPoolGetResponse putDataItem(String key, Object dataItem) {
    if (this.data == null) {
  ...
  /**
   * Return true if this ntfPool_GetResponse object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    NtfPoolGetResponse ntfPoolGetResponse = (NtfPoolGetResponse) o;
    return Objects.equals(this.success, ntfPoolGetResponse.success) &&
        Objects.equals(this.data, ntfPoolGetResponse.data);
  }
