...
/**
 * Payloads para POST /v1/whatsapp/messages (API usa "message" para texto, "mediaUrl" para mídia).
 */
...
public final class WhatsAppPayloads {
    ...
    /** Tipo image, video, audio, document: mediaUrl, fileName e mimetype obrigatórios; caption opcional (OpenAPI) */
