...
/**
 * NtfVoiceSendSuccessData Class Doc Comment
 *
 * @category Class
 * @package  NotifiqueOpenApi
 * @author   OpenAPI Generator team
 ...
 */
class NtfVoiceSendSuccessData implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'NtfVoice_SendSuccessData';
     ...
     * Sets message_ids
     *
     * @param string[] $message_ids IDs das chamadas enfileiradas (um por destino em `to`).
     *
     * @return self
     */
