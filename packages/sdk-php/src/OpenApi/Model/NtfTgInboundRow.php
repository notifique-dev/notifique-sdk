...
/**
 * NtfTgInboundRow Class Doc Comment
 *
 * @category Class
 * @package  NotifiqueOpenApi
 * @author   OpenAPI Generator team
 ...
 */
class NtfTgInboundRow implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'NtfTg_InboundRow';
     ...
     * Sets from_label
     *
     * @param string|null $from_label Rótulo do remetente (@username, nome ou chat).
     *
     * @return self
     */
