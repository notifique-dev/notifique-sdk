...
/**
 * NtfRcsRcsStatusResponseData Class Doc Comment
 *
 * @category Class
 * @package  NotifiqueOpenApi
 * @author   OpenAPI Generator team
 ...
 */
class NtfRcsRcsStatusResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'NtfRcs_RcsStatusResponse_data';
    ...
    {
        $this->setIfExists('rcs_id', $data ?? [], null);
    ...
    {
        return $this->container['rcs_id'];
    }

    /**
     * Sets rcs_id
     *
     * @param string|null $rcs_id rcs_id
     *
     * @return self
     */
    public function setRcsId($rcs_id)
    {
        if (is_null($rcs_id)) {
            throw new \InvalidArgumentException('non-nullable rcs_id cannot be null');
        }
        $this->container['rcs_id'] = $rcs_id;
     ...
     * Sets status
     *
     * @param string|null $status QUEUED = na fila; SCHEDULED = agendado; PROCESSING = aceito pelo provedor; SENT = enviado; DELIVERED = entregue; FAILED = falha; CANCELLED = cancelado.
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string|null $type Tipo: basic, card, carousel, file.
     *
     * @return self
     */
