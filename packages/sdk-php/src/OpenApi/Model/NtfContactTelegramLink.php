...
/**
 * NtfContactTelegramLink Class Doc Comment
 *
 * @category Class
 ...
 */
class NtfContactTelegramLink implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'NtfContact_TelegramLink';
     ...
     * Sets peer
     *
     * @param string|null $peer chat_id ou @username nesta instância
     *
     * @return self
     */
     ...
     * Sets instance_name
     *
     * @param string|null $instance_name Nome da instância (conexão)
     *
     * @return self
     */
