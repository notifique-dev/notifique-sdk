...
class ApiLog implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('request_query', $data ?? [], null);
    ...
    {
        return $this->container['request_query'];
    }

    /**
     * Sets request_query
     *
     * @param object|null $request_query request_query
     *
     * @return self
     */
    public function setRequestQuery($request_query)
    {
        if (is_null($request_query)) {
            throw new \InvalidArgumentException('non-nullable request_query cannot be null');
        }
        $this->container['request_query'] = $request_query;
