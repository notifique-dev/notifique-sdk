...
/**
 * NtfWaWhatsAppButtonReply Class Doc Comment
 *
 * @category Class
 ...
 */
class NtfWaWhatsAppButtonReply implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'NtfWa_WhatsAppButtonReply';
     ...
     * Sets id
     *
     * @param string $id Identificador único do botão (payload do clique).
     *
     * @return self
     */
