...
/**
 * NtfPlatformPaymentMethodCreateCreditCard Class Doc Comment
 *
 * @category Class
 * @package  NotifiqueOpenApi
 * @author   OpenAPI Generator team
 ...
 */
class NtfPlatformPaymentMethodCreateCreditCard implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'NtfPlatform_PaymentMethodCreate_creditCard';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('ccv', $data ?? [], null);
    }
    ...
    {
        if (is_null($ccv)) {
            throw new \InvalidArgumentException('non-nullable ccv cannot be null');
        }
