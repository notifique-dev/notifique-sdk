...
/**
 * NtfIgCreateInstanceBodyAuth Class Doc Comment
 *
 * @category Class
 * @package  NotifiqueOpenApi
 * @author   OpenAPI Generator team
 ...
 */
class NtfIgCreateInstanceBodyAuth implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'NtfIg_CreateInstanceBody_auth';
     ...
     *
     * @param string|null $verification_code Código 2FA quando a API retornou INSTAGRAM_TWO_FACTOR_REQUIRED.
     *
     * @return self
     */
