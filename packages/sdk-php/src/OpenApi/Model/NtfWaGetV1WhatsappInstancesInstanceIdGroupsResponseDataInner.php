...
/**
 * NtfWaGetV1WhatsappInstancesInstanceIdGroupsResponseDataInner Class Doc Comment
 *
 * @category Class
 * @package  NotifiqueOpenApi
 * @author   OpenAPI Generator team
 ...
 */
class NtfWaGetV1WhatsappInstancesInstanceIdGroupsResponseDataInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ntfWa_GetV1WhatsappInstancesInstanceIdGroupsResponse_data_inner';
     ...
     * Sets id
     *
     * @param string|null $id JID do grupo (ex.: 120363295648424210@g.us)
     *
     * @return self
     */
     ...
     * Sets creation
     *
     * @param int|null $creation creation
     *
     * @return self
     */
