...
/**
 * NtfVoiceActionBody Class Doc Comment
 *
 * @category Class
 ...
 */
class NtfVoiceActionBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'NtfVoice_ActionBody';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('max_digits', $data ?? [], null);
    ...
    public function setMaxDigits($max_digits)
    {
        if (is_null($max_digits)) {
            throw new \InvalidArgumentException('non-nullable max_digits cannot be null');
        }
     ...
     * Sets timeout_secs
     *
     * @param int|null $timeout_secs timeout_secs
     *
     * @return self
     */
