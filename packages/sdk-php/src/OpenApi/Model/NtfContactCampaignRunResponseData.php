...
/**
 * NtfContactCampaignRunResponseData Class Doc Comment
 *
 * @category Class
 * @package  NotifiqueOpenApi
 * @author   OpenAPI Generator team
 ...
 */
class NtfContactCampaignRunResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'NtfContact_CampaignRunResponse_data';
     ...
     * Sets sent
     *
     * @param int $sent Mensagens enfileiradas
     *
     * @return self
     */
     ...
     * Sets run_id
     *
     * @param string $run_id ID da execução (CampaignRun)
     *
     * @return self
     */
