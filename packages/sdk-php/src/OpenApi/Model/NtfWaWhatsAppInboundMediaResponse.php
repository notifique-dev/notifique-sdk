<?php
/**
 * NtfWaWhatsAppInboundMediaResponse
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * NtfWaWhatsAppInboundMediaResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class NtfWaWhatsAppInboundMediaResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'NtfWa_WhatsAppInboundMediaResponse';
     ...
     * Sets base64
     *
     * @param string $base64 Conteúdo do arquivo codificado em base64 (sem prefixo data:).
     *
     * @return self
     */
