...
/**
 * NtfAddonsNewsletterSubscribeRequest Class Doc Comment
 *
 * @category Class
 * @package  NotifiqueOpenApi
 * @author   OpenAPI Generator team
 ...
 */
class NtfAddonsNewsletterSubscribeRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'NtfAddons_NewsletterSubscribeRequest';
    ...
    public function setEmail($email)
    {
        ...
        if ((mb_strlen($email) < 1)) {
            throw new \InvalidArgumentException('invalid length for $email when calling NtfAddonsNewsletterSubscribeRequest., must be bigger than or equal to 1.');
        }
     ...
     * Sets preferences
     *
     * @param array<string,string>|null $preferences Substitui preferências existentes; valores não-string são convertidos
     *
     * @return self
     */
