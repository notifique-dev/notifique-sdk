...
/**
 * NtfPlatformPaymentMethodCreateCreditCardHolderInfo Class Doc Comment
 *
 * @category Class
 * @package  NotifiqueOpenApi
 * @author   OpenAPI Generator team
 ...
 */
class NtfPlatformPaymentMethodCreateCreditCardHolderInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'NtfPlatform_PaymentMethodCreate_creditCardHolderInfo';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['address_number'] === null) {
            $invalidProperties[] = "'address_number' can't be null";
        }
     ...
     * Sets cpf_cnpj
     *
     * @param string $cpf_cnpj cpf_cnpj
     *
     * @return self
     */
