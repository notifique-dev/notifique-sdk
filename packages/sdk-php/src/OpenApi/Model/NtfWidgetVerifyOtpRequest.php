...
/**
 * NtfWidgetVerifyOtpRequest Class Doc Comment
 *
 * @category Class
 * @package  NotifiqueOpenApi
 * @author   OpenAPI Generator team
 ...
 */
class NtfWidgetVerifyOtpRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ntfWidget_verifyOtp_request';
    ...
    public function setCode($code)
    {
        ...
        if ((mb_strlen($code) > 6)) {
            throw new \InvalidArgumentException('invalid length for $code when calling NtfWidgetVerifyOtpRequest., must be smaller than or equal to 6.');
        }
        if ((mb_strlen($code) < 6)) {
            throw new \InvalidArgumentException('invalid length for $code when calling NtfWidgetVerifyOtpRequest., must be bigger than or equal to 6.');
        }
