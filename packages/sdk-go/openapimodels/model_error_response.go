...
func NewErrorResponse(success bool, error_ string, message string, code string) *ErrorResponse {
	this := ErrorResponse{}
...
func (o *ErrorResponse) GetMissingVariables() []string {
...
// and a boolean to check if the value has been set.
func (o *ErrorResponse) GetMissingVariablesOk() ([]string, bool) {
	if o == nil || IsNil(o.MissingVariables) {
		return nil, false
	}
...
func (o *ErrorResponse) HasMissingVariables() bool {
	if o != nil && !IsNil(o.MissingVariables) {
		return true
	}
...
// SetMissingVariables gets a reference to the given []string and assigns it to the MissingVariables field.
func (o *ErrorResponse) SetMissingVariables(v []string) {
